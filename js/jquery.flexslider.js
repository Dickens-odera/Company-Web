...
(function(jQuery) {
    ...
    jQuery.flexslider.defaults = {
        ...
        multipleKeyboard: false, //{NEW} Boolean: Allow keyboard navigation to affect multiple slider. Default behavior cuts out keyboard navigation with more than one slider present.
