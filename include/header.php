                        ...
                        <div class="col-md-12" >
                            <div class="main-menu" style="position:center; ">
                                ...
                                <ul class="hidden-xs">
                                    ...
                                    <li class="custom-menu <?php
                                    if ($page_link != '' && $page_link == 'index') {
                                        echo 'active';
                                    }
                                    ...
                                    <li class=" custom-menu  <?php
                                    if ($page_link != '' && $page_link == 'about_us') {
                                        echo 'active';
                                    }
                                    ...
                                    <li class="custom-menu <?php
                                    if ($page_link != '' && $page_link == 'services') {
                                        echo 'active';
                                    }
                                    ...
                                    <li class="custom-menu  <?php
                                    if ($page_link != '' && $page_link == 'products') {
                                        echo 'active';
                                    }
                                    ...
                                    <li class="megamenu  <?php
                                    if ($page_link != '' && $page_link == 'pricing') {
                                        echo 'active';
                                    }
                                    ?>"><a href="pricing">Pricing</a>
                                    </li>
                                    <li class=" megamenu <?php
                                    if ($page_link != '' && $page_link == 'contact_us') {
                                        echo 'active';
                                    }
